...
Core **AuthOps** types for Aspire hosting: shared provider/app model, pipeline gates (`prereq-auth`, `deploy-auth`), and generic `WithAuth` environment injection (`AUTH_*`).
