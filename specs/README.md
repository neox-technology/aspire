...
| [`azure-custom-domains`](features/azure-custom-domains.md) | implemented | ACA custom domain ops hosting package (DomainOps providers, OctoDNS-in-Docker, ARM managed cert bind, `aspire do` steps) |
