...
| [`auth-providers`](features/auth-providers.md) | implemented | AuthOps — abstract `AuthAppRegistrationResource`; Entra `WithAuth` → `AzureAd__*` (Identity.Web); samples WebAPI/Blazor/Ops |
