namespace Neox.Aspire.EntityFrameworkCore.MigrationWorker.Tests.PostgreSql.ServiceDefaults;

public static class ServiceNames
{
    public const string Prefix = "neox-efmw-pg";

    public static class Infrastructure
    {
        public const string Postgres = $"{Prefix}-infrastructure-postgres";
    }
